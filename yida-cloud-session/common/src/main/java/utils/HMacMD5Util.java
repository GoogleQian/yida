...
public class HMacMD5Util {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        String key="Xiaohe@2019";
        String src="123456789012345";
        byte[] macmd5 = HMacMD5Util.getHmacMd5Bytes(key.getBytes(), src.getBytes());
        System.out.println(ConstantUtil.PRE_MD5_PWD+HMacMD5Util.bytesToHexString(macmd5).toString());
        String[] advRets = "1,867480030021881,".split(",");
        byte[] bytes = advRets[1].getBytes();
    }
}
